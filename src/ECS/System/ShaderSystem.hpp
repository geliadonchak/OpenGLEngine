...
#ifndef OPENGLENGINE_ECS_SYSTEM_SHADER_SYSTEM_HPP
#define OPENGLENGINE_ECS_SYSTEM_SHADER_SYSTEM_HPP
...
class ShaderSystem : public ISystem {
  public:
    ...
    void onLoad() override {
        ...
        static_cast<ECS::Components::Shader *>(getComponent())->setShaderId(programId);
        // todo fill shader data
    }
...
struct ShaderDataEntry {
    ShaderDataEntry(std::string name_, T value_) :
...
std::map<std::string, ShaderDataEntry> a;

}
}

#endif // OPENGLENGINE_ECS_SYSTEM_SHADER_SYSTEM_HPP