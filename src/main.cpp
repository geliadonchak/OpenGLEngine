...
//    Shader light_cube_shader(s3, s4);
    ...
    std::string s1 = "../resources/shaders/model.vs";
    std::string s2 = "../resources/shaders/model.fs";
    Shader model_shader(s1, s2);

    Camera camera;
    stbi_set_flip_vertically_on_load(true);
    Model model("/home/gelia/Workspace/opengl/resources/models/backpack/backpack.obj");
